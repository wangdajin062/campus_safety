...
ax1.set_title("a) Layer-selection ablation ",
              weight="bold", fontsize=11, pad=15)

ax1b = ax1.twinx()
ax1b.grid(False)
ax1b.plot(x, drift, "o-", color=color2, lw=1.5, ms=5, label="Var drift ($\\downarrow$)")
...
ax2.plot(ratios, f1_r, "o-", color="#1f77b4", lw=1.5, ms=6, label="F1 ($\\uparrow$)")
...
ax2.set_title(" b) Step-ratio ablation ",
              weight="bold", fontsize=11, pad=15)

ax2b = ax2.twinx()
ax2b.grid(False)
ax2b.plot(ratios, ppl_r, "s--", color="#d62728", lw=1.5, ms=5, label="PPL ($\\downarrow$)")
...
tnr_text(ax2, 30, 0.9248, "ours: 30%",
         ha="center", color="#cc5500", weight="bold")

sci.save(fig, "fig04_ovf_ablation.png", w=8.0, h=3.2)
